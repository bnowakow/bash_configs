...
helm upgrade cert-manager jetstack/cert-manager \
  ...
  --create-namespace \
  --version v1.19.4 --set startupapicheck.timeout=5m --set crds.enabled=true
kubectl apply --validate=false -f https://github.com/jetstack/cert-manager/releases/download/v1.19.4/cert-manager.crds.yaml
